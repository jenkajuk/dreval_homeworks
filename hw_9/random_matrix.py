...
print("Программа для створення квадратної матриці з випадковими значеннями")
...
while N == 0:
    ...
    if N.isdigit() is True:
        ...
        print("Помилка. Ви ввели не число або використали літери чи інші символи.")
        N = 0
...
print("Сума чисел по діагоналі зправа:", diag_summ)

# визначаю сумму чисел в останньому стовбчику
col_summ = sum(element[-1] for element in matrix)
print("Сума чисел останнього стовбчика матриці:", col_summ)
